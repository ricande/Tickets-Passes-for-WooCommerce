...
/**
 * Timeslot Tickets admin screen: every issued timeslot ticket, with the standard row actions.
 *
 * Everything but the table names and labels lives in TPFW_Dashboard.
 *
 * @package Tickets_Passes_For_WooCommerce
 */
class TPFW_Timeslot_Ticket_Dashboard extends TPFW_Dashboard
{
	protected $sSlug                    = 'tpfw-timeslot-tickets';
	protected $sTableClass              = 'TPFW_Timeslot_Tickets_Table_Dashboard';
	protected $sActionKey               = 'timeslot_ticket';
	protected $sCheckinKey              = 'timeslot';
	protected $sTable                   = 'tpfw_timeslot_tickets';
	protected $sResetMethod             = 'reset_timeslot_ticket';
	protected $sCancelMethod            = 'cancel_timeslot_ticket';
	...
	{
		$this->sMenuLabel        = __('Timeslot Tickets', 'tickets-passes-for-woocommerce');
		$this->sRowLabel         = __('Timeslot Ticket', 'tickets-passes-for-woocommerce');
		$this->sPageTitle        = __('Timeslot Tickets', 'tickets-passes-for-woocommerce');
...
/**
 * WP_List_Table rendering of the timeslot tickets table.
 */
class TPFW_Timeslot_Tickets_Table_Dashboard extends TPFW_Dashboard_Table
{
	protected $sTable         = 'tpfw_timeslot_tickets';
	protected $sStatsTable    = 'tpfw_timeslot_tickets_stats';
	protected $aSearchColumns = array('timeslot_id', 'nano_id', 'user_id', 'order_id', 'id');
	...
	{
		parent::__construct($oFunctions, $oDashboard, array('singular' => 'timeslot_ticket', 'plural' => 'timeslot_tickets'));
	}
	...
	public function get_columns()
	{
		return array(
			...
			'timeslot_id' => __('Timeslot ID', 'tickets-passes-for-woocommerce'),
	...
	protected function build_row($oResult, $aCtx)
	{
		...
		$aRow['timeslot_id'] = $this->oFunctions->get_truncated_id_html($oResult->timeslot_id);
